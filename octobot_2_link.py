...
#plane = p.loadURDF( os.path.join( pybullet_data.getDataPath(), "romans_urdf_files/octopus_files/octopus_2_link_v2.urdf" ) )
plane = p.loadURDF( os.path.join( pybullet_data.getDataPath(), "romans_urdf_files/octopus_files/octopus_2_link_v2.urdf" ) )
#note: the datapath directory changes depending on the anaconda environment that is currently activated when this python script is run, this is probably because we pip installed pybullet as an executable
